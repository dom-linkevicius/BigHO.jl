@testset "Manual" begin
    ...
    # never evaluation.
    ho = Hyperoptimizer(nothing, (a=range(1, stop=2, length=50), b=[true, false], c=randn(100)); n=10)
    show(devnull, ho)
    for _ in 1:10
        trial = ask(ho)
    ...
    ho2 = Hyperoptimizer(nothing, (a=range(1, stop=2, length=50), b=[true, false], c=randn(100)); n=10)
