...
_check_objective(s::SuccessiveHalving, objective) = objective isa Stateful || objective === nothing || @warn "$(typeof(s)) with a non-Stateful objective: promoted trials can't " *
